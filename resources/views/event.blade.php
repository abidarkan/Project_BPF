                                    ...
                                    @if ($events->count() > 0)
                                        @foreach ($events as $event)
                                            <tr>
                                                ...
                                                <!-- Actions Column -->
                                                <td>
                                                    <a href="{{ route('event_edit', ['event' => $event->event_id]) }}" class="btn btn-primary btn-sm">Edit</a>
                                                    <form action="{{ route('event_destroy', ['event' => $event->event_id]) }}" method="POST" style="display:inline;">
                                                        @csrf
                                                        @method('DELETE')
