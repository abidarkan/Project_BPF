        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-5 text-center mx-auto">
                    ...
                    <p class="text-lead text-white">Use these awesome forms to login or create a new account for free.</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card z-index-0">
                    <div class="card-body">
                        <form role="form text-left" method="POST" action="/register" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="profile_picture" class="form-label">Upload Profile Picture (Optional)</label>
